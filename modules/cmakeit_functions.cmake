...
function(cmakeit_target_apply_build_properties IS_UNITTEST UNITTEST_NAME)
	...
	if(IS_UNITTEST)
		...
		target_compile_definitions(${TARGET_NAME} PRIVATE "_UNITTEST")
	...
	elseif((CMAKEIT_COMPILER STREQUAL ${CMAKEIT_COMPILER_CLANG}) OR (CMAKEIT_COMPILER STREQUAL ${CMAKEIT_COMPILER_GCC}))
		...
		if((NOT IS_UNITTEST) AND ((CMAKEIT_MODULE_TYPE STREQUAL ${CMAKEIT_MODULE_TYPE_LIBRARY}) AND (CMAKEIT_MODULE_SUBTYPE STREQUAL ${CMAKEIT_MODULE_SUBTYPE_SHARED})))
	...
	if((NOT IS_UNITTEST) AND (NOT CMAKEIT_MODULE_NO_PCH) AND (CMAKEIT_MODULE_PCH_HEADER_FILENAME))
