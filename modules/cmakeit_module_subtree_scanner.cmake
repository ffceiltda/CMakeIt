	...
	foreach(FILENAME ${INTERNAL_MODULE_SUBTREE_SCANNER_UNIT_TESTS_FILES})
		...
		if(INTERNAL_IS_RESULT)
			...
			if(INTERNAL_WAS_CONFIGURED)
				...
				string(REPLACE "${CMAKE_CURRENT_SOURCE_DIR}/tests/" "" INTERNAL_UNITTEST_FILENAME ${TARGET_CONFIGURED_FILENAME})
	

			else()
		
				string(REPLACE "${CMAKE_CURRENT_SOURCE_DIR}/tests/" "" INTERNAL_UNITTEST_FILENAME ${FILENAME})
	
				list(APPEND CMAKEIT_MODULE_UNIT_TEST_FILES ${FILENAME})

			endif()
			
			message(STATUS "| | +-- Adding unit test ${INTERNAL_UNITTEST_FILENAME} ...")
